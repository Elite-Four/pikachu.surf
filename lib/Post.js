...
const postTemplatePath = require.resolve('./post.md.mustache')
const postTemplate = readFileSync(postTemplatePath, 'utf8')
mustache.parse(postTemplate)

const postsTemplatePath = require.resolve('./posts.md.mustache')
const postsTemplate = readFileSync(postsTemplatePath, 'utf8')
